...
const CollectTaxes = () => {
    ...
    const handleCollectTaxes = async () => {
        ...
        try {
            ...
            console.log("Taxes collected successfully");
            setErrorMessage(""); // Clear error if successful
        } catch (error) {
    
            let errorMsg = "An error occurred while collecting taxes. Possible reasons include: You are not the ruler of this nation, or your nation is in peace mode.";
