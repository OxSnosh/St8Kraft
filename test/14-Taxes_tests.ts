...
describe("Taxes Contract", function () {
    ...
    describe("Taxes Contract / Income Tests", function () {
        ...
        it("taxes1 tests additions to income", async function () {
            ...
            expect(dailyIncome7.toNumber()).to.equal(99);
        })
    })
})
