...
describe("Nation Strength Contract", function () {
    let warbucks;
    ...
    describe("Nation Strength", function () {
        it("strength1 tests strength", async function () {
            ...
            (0, chai_1.expect)(strength.toNumber()).to.equal(90);
            ...
            var strength = await nationstrengthcontract.getNationStrength(0);
            (0, chai_1.expect)(strength.toNumber()).to.equal(7250);
            ...
            (0, chai_1.expect)(strength5.toNumber()).to.equal(168500);
        });
    });
});
