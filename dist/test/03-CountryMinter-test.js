...
describe("CountryMinter", function () {
    ...
    describe("Minting a Country", function () {
        it("Tests that the nation parameters set correctly", async function () {
            ...
            (0, chai_1.expect)(capitalCity).to.equal("TestCapitalCity");
            (0, chai_1.expect)(nationSlogan).to.equal("TestNationSlogan");
        });
        it("Tests that the countryId increments correctly", async function () {
            ...
            (0, chai_1.expect)(countryId).to.equal(1);
            ...
            (0, chai_1.expect)(countryId2).to.equal(2);
        });
        ...
        it("Tests check ownership (false)", async function () {
            ...
            (0, chai_1.expect)(owner).to.equal(false);
        });
    });
});
