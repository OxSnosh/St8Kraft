...
describe("Country Parameters", function () {
    ...
    beforeEach(async function () {
        ...
        await warbucks.connect(signer0).transfer(signer1.address, BigInt(25000000000000000000000000));
        const tx1 = await countryminter.connect(signer1).generateCountry("TestRuler", "TestNationName", "TestCapitalCity", "TestNationSlogan");
    ...
    describe("Preferences Setup", function () {
        it("Tests that religion and government preference were randomly selected", async function () {
            ...
            (0, chai_1.expect)(preferredReligion1).to.equal(10);
            ...
            (0, chai_1.expect)(preferredGovernment1).to.equal(7);
            //Nation 1
            let preferredReligion2 = await countryparameterscontract.getReligionPreference(1);
            // console.log("Rel 2", preferredReligion2.toNumber());
            (0, chai_1.expect)(preferredReligion2).to.equal(2);
            let preferredGovernment2 = await countryparameterscontract.getGovernmentPreference(1);
            // console.log("Gov 2", preferredGovernment2.toNumber());
            (0, chai_1.expect)(preferredGovernment2).to.equal(4);
        });
    });
    describe("Preferences Functions", function () {
        it("Tests that the setRulerName() function works", async function () {
            ...
            (0, chai_1.expect)(rulerName).to.equal("TestRuler");
            ...
            (0, chai_1.expect)(newRulerName).to.equal("newName");
        });
        it("Tests that the setRulerName() function reverts correctly", async function () {
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setRulerName("newName", 0)).to.be.revertedWith("!nation owner");
        });
        it("Tests that the setNationName() function works", async function () {
            ...
            (0, chai_1.expect)(nationName).to.equal("TestNationName");
            ...
            (0, chai_1.expect)(newNationName).to.equal("newNationName");
        });
        it("Tests that the setNationName() function reverts correctly", async function () {
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setRulerName("newNationName", 0)).to.be.revertedWith("!nation owner");
        });
        it("Tests that the setCapitalCity() function works", async function () {
            ...
            (0, chai_1.expect)(capital).to.equal("TestCapitalCity");
            ...
            (0, chai_1.expect)(newCapital).to.equal("newCapital");
        });
        it("Tests that the setCapitalCity() function reverts correctly", async function () {
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setCapitalCity("newCap", 0)).to.be.revertedWith("!nation owner");
        });
        it("Tests that the setSlogan() function works", async function () {
            ...
            (0, chai_1.expect)(slogan).to.equal("TestNationSlogan");
            ...
            (0, chai_1.expect)(newSlogan).to.equal("newSlogan");
        });
        it("Tests that the setSlogan() function reverts correctly", async function () {
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setNationSlogan("newSlogan", 0)).to.be.revertedWith("!nation owner");
        });
        it("Tests that the setAlliance() function works", async function () {
            ...
            (0, chai_1.expect)(alliance).to.equal("No Alliance Yet");
            ...
            (0, chai_1.expect)(newAlliance).to.equal("newAlliance");
        });
        it("Tests that the setAlliance() function reverts correctly", async function () {
            (0, chai_1.expect)(countryparameterscontract.connect(signer2).setAlliance("newAlliance", 0)).to.be.revertedWith("!nation owner");
        });
        it("Tests that the setTeam() function works", async function () {
            ...
            (0, chai_1.expect)(team).to.equal(0);
            ...
            (0, chai_1.expect)(newTeam).to.equal(6);
        });
        it("Tests that the setTeam() function reverts correctly", async function () {
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setAlliance("newAlliance", 0)).to.be.revertedWith("!nation owner");
        });
        it("Tests that the setGovernment() function works", async function () {
            ...
            (0, chai_1.expect)(government).to.equal(0);
            ...
            (0, chai_1.expect)(daysSince[0].toNumber()).to.equal(6);
            ...
            (0, chai_1.expect)(newGovernment).to.equal(4);
        });
        it("Tests that the setGovernment() function reverts correctly when called by !owner", async function () {
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setGovernment(0, 0)).to.be.revertedWith("!nation owner");
        });
        it("Tests that the setGovernment() function reverts correctly when called too soon", async function () {
            ...
            await keepercontract.incrementGameDay();
            await countryparameterscontract.connect(signer1).setGovernment(0, 4);
            await (0, chai_1.expect)(countryparameterscontract.connect(signer1).setGovernment(0, 5)).to.be.revertedWith("need to wait 3 days before changing");
        });
        it("Tests that setGovernment() function works when called with a fallout shelter", async function () {
            ...
            await (0, chai_1.expect)(countryparameterscontract.connect(signer1).setGovernment(0, 6)).to.be.revertedWith("nation in anarchy, must wait 5 days");
            await wonderscontract1.connect(signer1).buyWonder1(0, 6);
            await (0, chai_1.expect)(countryparameterscontract.connect(signer1).setGovernment(0, 6)).to.be.revertedWith("nation in anarchy, must wait 4 days");
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            ...
            (0, chai_1.expect)(govt).to.equal(6);
        });
        it("Tests that the setGovernment() function reverts correctly when called with wrong type", async function () {
            ...
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            await (0, chai_1.expect)(countryparameterscontract.connect(signer1).setGovernment(0, 15)).to.be.revertedWith("invalid type");
        });
        it("Tests that the setReligion() function works", async function () {
            ...
            (0, chai_1.expect)(religion).to.equal(0);
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            ...
            await keepercontract.incrementGameDay();
            let daysSince = await countryparameterscontract.getDaysSince(0);
            (0, chai_1.expect)(daysSince[1].toNumber()).to.equal(6);
            ...
            (0, chai_1.expect)(newReligion).to.equal(5);
        });
        it("Tests that the setReligion() function reverts correctly when called by !owner", async function () {
            ...
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            await (0, chai_1.expect)(countryparameterscontract.connect(signer2).setReligion(0, 0)).to.be.revertedWith("!nation owner");
        });
        it("Tests that the setReligion() function reverts correctly when called too soon", async function () {
            ...
            await (0, chai_1.expect)(countryparameterscontract.connect(signer1).setReligion(0, 5)).to.be.revertedWith("need to wait 3 days before changing");
        });
        it("Tests that the setReligion() function reverts correctly when called with worng type", async function () {
            ...
            await keepercontract.incrementGameDay();
            await keepercontract.incrementGameDay();
            await (0, chai_1.expect)(countryparameterscontract.connect(signer1).setReligion(0, 15)).to.be.revertedWith("invalid type");
        });
        ...
        it("tests that get day created works correctly", async function () {
            ...
            (0, chai_1.expect)(dayCreated.toNumber()).to.equal(0);
        });
    });
